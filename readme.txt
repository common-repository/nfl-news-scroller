...
NFL News Scroll shows the top 10 NFL headlines, updated every 3-4 hours during the regular season.

== Description ==

This plugin adds a simple, straightforward news scroller to your website, which rotates the top ten latest NFL headlines. The scroller's news feed is update multiple times per day, so that your blog visitors can get the most current news.

Blog owners can fully customize the font color of the scroller, and the backgrounds of each even and odd news items (ie. items 1,3,5... yellow background; 2,4,6... white background). The scroller automatically numbers the 10 news items, and puts the news item titles in bold in order to make them stand out on your pages. The scroller moves along slowly, stopping for 6 seconds each time a headline reaches the top of the scroller window.
...
We have no outward 
preference where our plugin appears, as long as the website content is legal in its particular jurisdiction. For example, some <a href="http://www.nfl-betting.com">NFL betting</a> 
bloggers like to use the stats to complement NFL content on their sites, while more hard core <a href="http://www.more-online-casinos.us">online casinos</a> enthusiasts will use multiple instances 
...
1. Upload `nfl-news-scroll` fodler to the `/wp-content/plugins/` directory
...
As of the most current release, we're restricting the amount of variables that can be customized to font and background colors only. We will eventually add functionality to change other variables of the scroller.
...
No problem, feel free to use this plugin on sites that offer legal information about sports gaming, such as <a href="http://www.online-casinos-royale.com">online casinos</a> blogs. In general, your 
...
on any websites that incite hate, prejudice, violence, terrorism, or any sort intolerance for diversity is discouraged. Can I post on an <a href="http://www.bet-on-the-nfl.com">NFL betting</a> 
...
1. Sample Screen Shot of Scroller `/tags/0.8/screenshot-1.png`<br />
